...
exports.WgetRItem = exports.WgetRItemBase = exports.SitemapItem = exports.WgetR = void 0;
...
exports.WgetRItemBase = WgetRItemBase;
class WgetRItem extends WgetRItemBase {
    async getContent() {
        return this._content || (this._content = super.getContent());
    }
}
exports.WgetRItem = WgetRItem;
