...
exports.WgetItem = exports.WgetItemRaw = exports.SitemapItem = exports.wgetR = void 0;
...
exports.WgetItemRaw = WgetItemRaw;
class WgetItem extends WgetItemRaw {
    async getContent() {
        return this._content || (this._content = super.getContent());
    }
}
exports.WgetItem = WgetItem;
